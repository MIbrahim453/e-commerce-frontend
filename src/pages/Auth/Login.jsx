...
export default function Login() {
  ...
  return (
    <div className="h-screen! w-full! bg-white! flex! flex-col! lg:flex-row! overflow-y-auto! lg:overflow-hidden!">
      <div className="w-full! lg:w-1/2! relative! min-h-[340px]! lg:h-screen! flex! flex-col! justify-between! p-6! sm:p-8! lg:p-8! xl:p-10! overflow-hidden! shrink-0!">
        <img
      ...
      <div className="w-full! lg:w-1/2! lg:h-screen! bg-white! flex! flex-col! justify-between! p-4! sm:p-6! lg:px-10! lg:py-5! xl:px-14! xl:py-7! relative! overflow-y-auto! lg:overflow-hidden!">
